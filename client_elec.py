...
pick_position1=np.array([-0.49, 0.654, 0.135])
pick_position2=np.array([0.62, 0.58, 0.138])
...
def pp_fabric(temp_path,pick_position,ROI,v=2.5):
	global current_frame
	...
	p_fabric=conversion(p[0],p[1],pick_position[-1])
	...
	place(place_position+(pick_position-p_fabric),R_ee.R_ee(eef_angle-np.radians(angle)))
	# discharge()
...
try:
	pp_fabric('client_yaml/template0.png',pick_position2,ROI2,v=5.)
