...
#table ROI
ROI=np.array([[168,776],[409,1410]])	#ROI [[r1,r2],[c1,c2]]
#template size
template_size=360*1.414
#load template
template=cv2.imread('image_data/fabric.png',cv2.IMREAD_UNCHANGED)
...
#load test image
test_image=cv2.imread('image_data/fabric.jpg',cv2.IMREAD_UNCHANGED)
