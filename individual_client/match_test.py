...
#load template
template=cv2.imread('../client_yaml/template1.png',cv2.IMREAD_UNCHANGED)
...
#load test image
test_image=cv2.imread('image_data/temp1_test1.jpg',cv2.IMREAD_UNCHANGED)
